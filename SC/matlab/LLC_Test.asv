...
img_dir = 'image/CIFAR-10/test';       % directory for the image database                             
data_dir = 'data/CIFAR-10/test';       % directory for saving SIFT descriptors
fea_dir = 'features/CIFAR-10/test';    % directory for saving final image features
...
Bpath = ['dictionary/CIFAR-10_SIFT_Kmeans_1024.mat'];
